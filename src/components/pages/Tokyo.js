    ...
    return ( 
        <Fragment>
            <div className={style.title}>
                    <img src="/react-website/images/Tokyo Skyline.jpg" alt="Tokyo" />
            ...
            <div>
                    <ol className={style.list}>
                            ...
                            <li><h2>Shibuya (渋谷区)</h2>
                                ...
                                <img className={style.thumbnail} src="/react-website/images/shibuya.jpg" alt="Shibuya"/>
                            </li><br></br>
                        ...
                        <li><h2>Parco di Ueno (上野公園) </h2>
                            ...
                            <img className={style.thumbnail} src="/react-website/images/ueno1.jpg" alt="Parco di Ueno"/>
                        </li><br></br>
                        </ol>
            </div>
            <div>
