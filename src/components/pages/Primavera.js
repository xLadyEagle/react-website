       ...
       <Fragment>
            ...
            <section className={style.text}>
                    <aside className={style.left}>
                        ...
                        <br></br><br></br>È considerato un <b>simbolo di rinnovamento</b>, bellezza e vitalità. <br></br>Ogni anno, durante la stagione primaverile, 
                            ...
                            <br></br><b><br></br>Il ciliegio, rappresenta</b> quindi <b>il Giappone</b>, e la sua delicatezza, la brevità della sua esistenza sono per i giapponesi 
                    ...
                    <div className={style.gallery}>
                        ...
                        <div className={style.caption}>Sakura</div>
                    </div><br></br>
                    ...
                    <br></br>
                        ...
                        <br></br>   
                        <p>Letteralmente, “hanami” significa “ammirare i fiori” e in Giappone si tratta di una <b>vera e propria tradizione</b>. 
                        La tradizione dell’hanami ha una storia millenaria e viene <b>vissuta intensamente</b> da tutto il Giappone, specialmente attraverso 
                        <b> picnic all'ombra dei ciliegi in fiore</b>, in cui si radunano familiari, amici e colleghi di lavoro, che si tengono in parchi, 
                        giardini di templi e castelli (a volte anche cimiteri), etc. 
                        <br></br><br></br>Esistono sono <b>manicaretti</b> che i giapponesi mangiano appositamente per l’occasione dell’Hanami. Fra di questi troviamo alcuni dolcetti 
                    ...
                    <section>
                        ...
                        nel sentimento di malinconia e commozione nel vederli cadere dai rami, <b>trasportati dal delicato vento primaverile</b>. 
                        Il fiore diventa così <b>simbolo di caducità</b>: proprio come i sakura sbocciano e ci donano la loro bellezza per un breve tempo, 
                        allo stesso modo noi percepiamo il <b>rapido scorrere della vita umana</b>.</p>
                    </section>

                    <section>
                        <h2>Previsioni fioritura 2022</h2>
                        <br></br>
                        ...
                        <p>Il tempo medio di fioritura dei <i>sakura</i> può variare a seconda della posizione geografica 
                            all’interno del paese. <br></br>Le aree con <b>climi invernali più miti vedono fiorire prima i ciliegi</b>. Solitamente, nelle regioni meridionali 
                            la fioritura avviene prima, procedendo man mano verso nord. <br></br>Il vento, la pioggia e la temperatura possono anticipare o posticipare 
                            la fioritura e allungare o accorciare la stagione dei fiori di ciliegio.</p><br></br>
                    </section>

                    <section>
                        <h2>La fioritura a Tokyo</h2>
                        <br></br>
                        <div className={style.clear}>
                        <p>Nonostante si tratti di una grande città, anche a Tokyo ci sono <b>tantissimi posti da cui ammirare i ciliegi in fiore</b>.<br></br>
